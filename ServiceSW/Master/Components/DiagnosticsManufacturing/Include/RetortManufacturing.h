/****************************************************************************/
/*! \file RetortManufacturing.h
 *
 *  \brief CRetort class definition for Manufacturing SW
 *
 *   $Version: $ 0.1
 *   $Date:    $ 2014-06-16
 *   $Author:  $ Dixiong Li
...
public:
     ...
     */
    /****************************************************************************/
    explicit CRetort(Core::CServiceGUIConnector *p_DataConnector = NULL, MainMenu::CMainWindow *p_Parent = NULL);
