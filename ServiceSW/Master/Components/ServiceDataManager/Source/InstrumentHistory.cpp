...
bool CInstrumentHistory::DeserializeContent(QIODevice &IODevice, bool CompleteData)
{
    ...
    if (!DataManager::Helper::ReadNode(XmlStreamReader, "InstrumentHistory")) {
 ...
 */
/****************************************************************************/
bool CInstrumentHistory::UpdateModuleList(CModuleDataList* p_ModuleList)
{
 ...
 *  \iparam ModuleList = Module data list
 *  \return true or false
 */
/****************************************************************************/
bool CInstrumentHistory::GetModuleList(const QString TimeStamp, CModuleDataList& ModuleList)
{
    if (m_ModuleList.contains(TimeStamp)) {
        ModuleList = *(m_ModuleList.value(TimeStamp));
        return true;
    } else {
        return false;
    }
...
//    ModuleList.SetModuleTimeStamp(p_ModuleList->GetModuleTimeStamp());
...
//        if (Module != NULL) {
//            (void) ModuleList.AddModule(Module);
//        }
//    }
//    delete p_ModuleList;
}
...
}   // end of namespace ServiceDataManager
