/****************************************************************************/
/*! \file ServiceDataManager/CommandInterface/Include/CommandInterfaceBase.h
 *
...
public:
     ...
     */
    /****************************************************************************/
    explicit CCommandInterfaceBase(CServiceDataManager *p_DataManager,
...
protected:
    //Pointer section
    CServiceDataManager                             *mp_DataManager;                     //!< Self Explaining
    Threads::ServiceMasterThreadController              *mp_MasterThreadController;          //!< Will be used to call BroadCastCommand
    ServiceDataContainer                 *mp_DataContainer;                   //!< Provides access to various containers
