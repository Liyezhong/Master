...
const quint32 EVENT_GUI_DIAGNOSTICS_ROTARYVALVE_HEATING_TEST                 = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x004C;  ///< 100728908 Rotary valve heating property test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_ROTARYVALVE_HEATING_TEST_SUCCESS         = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x004D;  ///< 100728909 Rotary valve heating property test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_ROTARYVALVE_HEATING_TEST_FAILURE         = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x004E;  ///< 100728910 Rotary valve heating property test failed
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_LIQUID_TEST             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x004F;  ///< 100728911 L&A system heating liquid test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_LIQUID_TEST_SUCCESS     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0050;  ///< 100728912 L&A system heating liquid test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_LIQUID_TEST_FAILURE     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0051;  ///< 100728913 L&A system heating liquid test failed
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_AIR_TEST                = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0052;  ///< 100728914 L&A system heating air test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_AIR_TEST_SUCCESS        = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0053;  ///< 100728915 L&A system heating air test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_AIR_TEST_FAILURE        = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0054;  ///< 100728916 L&A system heating air test failed
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_AIR_SYSTEM_TEST                 = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0055;  ///< 100728917 L&A system air system test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_AIR_SYSTEM_TEST_SUCCESS         = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0056;  ///< 100728918 L&A system air system test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_AIR_SYSTEM_TEST_FAILURE         = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0057;  ///< 100728919 L&A system air system test failed
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_ASB3_TEST                    = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0058;  ///< 100728920 Main control ASB3 test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_ASB3_TEST_SUCCESS            = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0059;  ///< 100728921 Main control ASB3 completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_ASB3_TEST_FAILURE            = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005A;  ///< 100728922 Main control ASB3 test failed
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_ASB5_TEST                    = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005B;  ///< 100728923 Main control ASB5 test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_ASB5_TEST_SUCCESS            = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005C;  ///< 100728924 Main control ASB5 completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_ASB5_TEST_FAILURE            = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005D;  ///< 100728925 Main control ASB5 test failed
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_ASB15_TEST                   = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005E;  ///< 100728926 Main control ASB15 test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_ASB15_TEST_SUCCESS           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005F;  ///< 100728927 Main control ASB15 completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_ASB15_TEST_FAILURE           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0060;  ///< 100728928 Main control ASB15 test failed
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_EBOX_TEST                    = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0061;  ///< 100728929 Main control EBox test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_EBOX_TEST_SUCCESS            = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0062;  ///< 100728930 Main control EBox completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_EBOX_TEST_FAILURE            = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0063;  ///< 100728931 Main control EBox test failed
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_TOUCH_SCREEN_TEST            = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0064;  ///< 100728932 Main control touch screen test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_TOUCH_SCREEN_TEST_SUCCESS    = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0065;  ///< 100728933 Main control touch screen completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_MAINCONTROL_TOUCH_SCREEN_TEST_FAILURE    = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0066;  ///< 100728934 Main control touch screen test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_BOTTLE_CHECKING_TEST              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0067;  ///< 100728935 System bottle checking test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_BOTTLE_CHECKING_TEST_SUCCESS      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0068;  ///< 100728936 System bottle checking test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_BOTTLE_CHECKING_TEST_FAILURE      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0069;  ///< 100728937 System bottle checking test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_FILLING_DRAINING_TEST             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006A;  ///< 100728938 System filling and draining test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_FILLING_DRAINING_TEST_SUCCESS     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006B;  ///< 100728939 System filling and draining test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_FILLING_DRAINING_TEST_FAILURE     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006C;  ///< 100728940 System filling and draining test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_OVERFLOW_TEST                     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006D;  ///< 100728941 System overflow test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_OVERFLOW_TEST_SUCCESS             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006E;  ///< 100728942 System overflow test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_OVERFLOW_TEST_FAILURE             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006F;  ///< 100728943 System overflow test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_SPEAKER_TEST                      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0070;  ///< 100728944 System speaker test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_SPEAKER_TEST_SUCCESS              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0071;  ///< 100728945 System speaker test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_SPEAKER_TEST_FAILURE              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0072;  ///< 100728946 System speaker test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ALARM_TEST                        = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0073;  ///< 100728947 System alarm test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ALARM_TEST_SUCCESS                = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0074;  ///< 100728948 System alarm test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ALARM_TEST_FAILURE                = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0075;  ///< 100728949 System alarm test is failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ETHERNET_TEST                     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0076;  ///< 100728950 System ethernet test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ETHERNET_TEST_SUCCESS             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0077;  ///< 100728951 System ethernet test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ETHERNET_TEST_FAILURE             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0078;  ///< 100728952 System ethernet test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_USB_TEST                          = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0079;  ///< 100728953 System usb test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_USB_TEST_SUCCESS                  = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007A;  ///< 100728954 System usb test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_USB_TEST_FAILURE                  = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007B;  ///< 100728955 System usb test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_MAINS_RELAY_TEST                  = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007C;  ///< 100728956 System mains relay test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_MAINS_RELAY_TEST_SUCCESS          = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007D;  ///< 100728957 System mains relay test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_MAINS_RELAY_TEST_FAILURE          = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007E;  ///< 100728958 System mains relay test is failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_VOLTAGE_TEST                      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007F;  ///< 100728959 System 110V/220V switching test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_VOLTAGE_TEST_SUCCESS              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0080;  ///< 100728960 System 110V/220V switching test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_VOLTAGE_TEST_FAILURE              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0081;  ///< 100728961 System 110V/220V switching test failed
const quint32 EVENT_GUI_MANUF_RETORT_TEST_REQUESTED                          = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0082;  ///< 100728962 Manufacturing: Retort module test is requested
const quint32 EVENT_GUI_MANUF_RETORT_SENDTESTREPORT_REQUESTED                = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0083;  ///< 100728963 Manufacturing: Retort send test report
const quint32 EVENT_GUI_MANUF_OVEN_TEST_REQUESTED                            = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0084;  ///< 100728964 Manufacturing: Oven module test is requested
const quint32 EVENT_GUI_MANUF_OVEN_SENDTESTREPORT_REQUESTED                  = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0085;  ///< 100728965 Manufacturing: Oven send test report
const quint32 EVENT_GUI_MANUF_ROTARYVALVE_TEST_REQUESTED                     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0086;  ///< 100728966 Manufacturing: Retort valve module test is requested
const quint32 EVENT_GUI_MANUF_ROTARYVALVE_SENDTESTREPORT_REQUESTED           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0087;  ///< 100728967 Manufacturing: Retort valve send test report
const quint32 EVENT_GUI_MANUF_LASYSTEM_TEST_REQUESTED                        = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0088;  ///< 100728968 Manufacturing: L&A system module test is requested
const quint32 EVENT_GUI_MANUF_LASYSTEM_SENDTESTREPORT_REQUESTED              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0089;  ///< 100728969 Manufacturing: L&A system send test report
const quint32 EVENT_GUI_MANUF_MAINCONTROL_TEST_REQUESTED                     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x008A;  ///< 100728970 Manufacturing: Main control module test is requested
const quint32 EVENT_GUI_MANUF_MAINCONTROL_SENDTESTREPORT_REQUESTED           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x008B;  ///< 100728971 Manufacturing: Main control send test report
const quint32 EVENT_GUI_MANUF_SYSTEM_TEST_REQUESTED                          = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x008C;  ///< 100728972 Manufacturing: System module test is requested
const quint32 EVENT_GUI_MANUF_SYSTEM_SENDTESTREPORT_REQUESTED                = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x008D;  ///< 100728973 Manufacturing: System send test report
