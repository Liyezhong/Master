...
const quint32 EVENT_GUI_SVCDIAGNOSTICS_PART_HEATING                           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x00A5;  ///< 100728997 Heating %1 activated and set temperature was %2 centigrade
