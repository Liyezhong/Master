...
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_FILLING_DRAINING_TEST_FAILURE      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006C;  ///< 100728940 System sealing function test failed
