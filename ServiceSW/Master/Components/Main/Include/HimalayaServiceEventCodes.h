...
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_BOTTLE_CHECKING_TEST              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0058;  ///< 100728920 System bottle checking test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_BOTTLE_CHECKING_TEST_SUCCESS      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0059;  ///< 100728921 System bottle checking test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_BOTTLE_CHECKING_TEST_FAILURE      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005A;  ///< 100728922 System bottle checking test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_FILLING_DRAINING_TEST             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005B;  ///< 100728923 System filling and draining test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_FILLING_DRAINING_TEST_SUCCESS     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005C;  ///< 100728924 System filling and draining test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_FILLING_DRAINING_TEST_FAILURE     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005D;  ///< 100728925 System filling and draining test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_OVERFLOW_TEST                     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005E;  ///< 100728926 System overflow test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_OVERFLOW_TEST_SUCCESS             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x005F;  ///< 100728927 System overflow test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_OVERFLOW_TEST_FAILURE             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0060;  ///< 100728928 System overflow test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_SPEAKER_TEST                      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0061;  ///< 100728929 System speaker test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_SPEAKER_TEST_SUCCESS              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0062;  ///< 100728930 System speaker test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_SPEAKER_TEST_FAILURE              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0063;  ///< 100728931 System speaker test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ALARM_TEST                        = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0064;  ///< 100728932 System alarm test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ALARM_TEST_SUCCESS                = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0065;  ///< 100728933 System alarm test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ALARM_TEST_FAILURE                = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0066;  ///< 100728934 System alarm test is failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ETHERNET_TEST                     = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0067;  ///< 100728935 System ethernet test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ETHERNET_TEST_SUCCESS             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0068;  ///< 100728936 System ethernet test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ETHERNET_TEST_FAILURE             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0069;  ///< 100728937 System ethernet test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_USB_TEST                          = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006A;  ///< 100728938 System usb test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_USB_TEST_SUCCESS                  = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006B;  ///< 100728939 System usb test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_USB_TEST_FAILURE                  = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006C;  ///< 100728940 System usb test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_MAINS_RELAY_TEST                  = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006D;  ///< 100728941 System mains relay test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_MAINS_RELAY_TEST_SUCCESS          = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006E;  ///< 100728942 System mains relay test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_MAINS_RELAY_TEST_FAILURE          = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006F;  ///< 100728943 System mains relay test is failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_VOLTAGE_TEST                      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0070;  ///< 100728944 System 110V/220V switching test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_VOLTAGE_TEST_SUCCESS              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0071;  ///< 100728945 System 110V/220V switching test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_VOLTAGE_TEST_FAILURE              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0072;  ///< 100728946 System 110V/220V switching test failed
