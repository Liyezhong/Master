...
const quint32 EVENT_GUI_DIAGNOSTICS_OVEN_HEATING_LIQUID_TEST                  = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x004E;  ///< 100728910 Oven heating test with liquid is requested
const quint32 EVENT_GUI_DIAGNOSTICS_OVEN_HEATING_LIQUID_TEST_SUCCESS          = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x004F;  ///< 100728911 Oven heating test with liquid completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_OVEN_HEATING_LIQUID_TEST_FAILURE          = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0050;  ///< 100728912 Oven heating test with liquid failed
...
const quint32 EVENT_GUI_SVCDIAGNOSTICS_PART_HEATING                           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x00A5;  ///< 100728997 Heating %1 activated and set temperature was %2\260C
