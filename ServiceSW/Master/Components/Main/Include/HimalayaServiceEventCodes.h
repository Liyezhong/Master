...
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_BOTTLE_CHECKING_TEST               = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006A;  ///< 100728938 System bottle checking test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_BOTTLE_CHECKING_TEST_SUCCESS       = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006B;  ///< 100728939 System bottle checking test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_BOTTLE_CHECKING_TEST_FAILURE       = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006C;  ///< 100728940 System bottle checking test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_FILLING_DRAINING_TEST              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006D;  ///< 100728941 System filling and draining test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_FILLING_DRAINING_TEST_SUCCESS      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006E;  ///< 100728942 System filling and draining test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_FILLING_DRAINING_TEST_FAILURE      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x006F;  ///< 100728943 System filling and draining test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_OVERFLOW_TEST                      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0070;  ///< 100728944 System overflow test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_OVERFLOW_TEST_SUCCESS              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0071;  ///< 100728945 System overflow test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_OVERFLOW_TEST_FAILURE              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0072;  ///< 100728946 System overflow test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_SPEAKER_TEST                       = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0073;  ///< 100728947 System speaker test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_SPEAKER_TEST_SUCCESS               = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0074;  ///< 100728948 System speaker test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_SPEAKER_TEST_FAILURE               = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0075;  ///< 100728949 System speaker test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ALARM_TEST                         = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0076;  ///< 100728950 System alarm test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ALARM_TEST_SUCCESS                 = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0077;  ///< 100728951 System alarm test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ALARM_TEST_FAILURE                 = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0078;  ///< 100728952 System alarm test is failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ETHERNET_TEST                      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0079;  ///< 100728953 System ethernet test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ETHERNET_TEST_SUCCESS              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007A;  ///< 100728954 System ethernet test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_ETHERNET_TEST_FAILURE              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007B;  ///< 100728955 System ethernet test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_USB_TEST                           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007C;  ///< 100728956 System usb test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_USB_TEST_SUCCESS                   = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007D;  ///< 100728957 System usb test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_USB_TEST_FAILURE                   = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007E;  ///< 100728958 System usb test failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_MAINS_RELAY_TEST                   = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x007F;  ///< 100728959 System mains relay test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_MAINS_RELAY_TEST_SUCCESS           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0080;  ///< 100728960 System mains relay test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_MAINS_RELAY_TEST_FAILURE           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0081;  ///< 100728961 System mains relay test is failed
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_VOLTAGE_TEST                       = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0082;  ///< 100728962 System 110V/220V switching test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_VOLTAGE_TEST_SUCCESS               = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0083;  ///< 100728963 System 110V/220V switching test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_SYSTEM_VOLTAGE_TEST_FAILURE               = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0084;  ///< 100728964 System 110V/220V switching test failed
const quint32 EVENT_GUI_MANUF_RETORT_TEST_REQUESTED                           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0085;  ///< 100728965 Manufacturing: Retort module test is requested
const quint32 EVENT_GUI_MANUF_RETORT_SENDTESTREPORT_REQUESTED                 = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0086;  ///< 100728966 Manufacturing: Retort send test report
const quint32 EVENT_GUI_MANUF_OVEN_TEST_REQUESTED                             = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0087;  ///< 100728967 Manufacturing: Oven module test is requested
const quint32 EVENT_GUI_MANUF_OVEN_SENDTESTREPORT_REQUESTED                   = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0088;  ///< 100728968 Manufacturing: Oven send test report
const quint32 EVENT_GUI_MANUF_ROTARYVALVE_TEST_REQUESTED                      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0089;  ///< 100728969 Manufacturing: Retort valve module test is requested
const quint32 EVENT_GUI_MANUF_ROTARYVALVE_SENDTESTREPORT_REQUESTED            = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x008A;  ///< 100728970 Manufacturing: Retort valve send test report
const quint32 EVENT_GUI_MANUF_LASYSTEM_TEST_REQUESTED                         = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x008B;  ///< 100728971 Manufacturing: L&A system module test is requested
const quint32 EVENT_GUI_MANUF_LASYSTEM_SENDTESTREPORT_REQUESTED               = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x008C;  ///< 100728972 Manufacturing: L&A system send test report
const quint32 EVENT_GUI_MANUF_MAINCONTROL_TEST_REQUESTED                      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x008D;  ///< 100728973 Manufacturing: Main control module test is requested
const quint32 EVENT_GUI_MANUF_MAINCONTROL_SENDTESTREPORT_REQUESTED            = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x008E;  ///< 100728974 Manufacturing: Main control send test report
const quint32 EVENT_GUI_MANUF_SYSTEM_TEST_REQUESTED                           = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x008F;  ///< 100728975 Manufacturing: System module test is requested
const quint32 EVENT_GUI_MANUF_SYSTEM_SENDTESTREPORT_REQUESTED                 = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0090;  ///< 100728976 Manufacturing: System send test report
