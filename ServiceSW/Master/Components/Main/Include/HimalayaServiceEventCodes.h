...
const quint32 EVENT_GUI_MODIFY_LASYSTEM_HEATING_BELT1_MODULE                 = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0025;  ///< 100728869 Modify L&A system heating belt 1 module info
const quint32 EVENT_GUI_MODIFY_LASYSTEM_HEATING_BELT2_MODULE                 = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0026;  ///< 100728870 Modify L&A system heating belt 2 module info
...
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_BELT1_TEST              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x004F;  ///< 100728911 L&A system heating belt 1 test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_BELT1_TEST_SUCCESS      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0050;  ///< 100728912 L&A system heating belt 1 test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_BELT1_TEST_FAILURE      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0051;  ///< 100728913 L&A system heating belt 1 test failed
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_BELT2_TEST              = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0052;  ///< 100728914 L&A system heating belt 2 test is requested
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_BELT2_TEST_SUCCESS      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0053;  ///< 100728915 L&A system heating belt 2 test completed successfully
const quint32 EVENT_GUI_DIAGNOSTICS_LASYSTEM_HEATING_BELT2_TEST_FAILURE      = EVENT_GROUP_HIMALAYASERVICE_MAIN + 0x0054;  ///< 100728916 L&A system heating belt 2 test failed
