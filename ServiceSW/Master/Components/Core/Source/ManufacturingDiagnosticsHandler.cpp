...
void CManufacturingDiagnosticsHandler::PerformManufRetortTests(const QList<Service::ModuleTestCaseID> &TestCaseList)
{
    ...
    for(int i=0; i<TestCaseList.size(); i++) {
        ...
        case Service::RETORT_HEATING_EMPTY:
            eventId = EVENT_GUI_DIAGNOSTICS_RETORT_HEATING_EMPTY_TEST;
            failureId = EVENT_GUI_DIAGNOSTICS_RETORT_HEATING_EMPTY_TEST_FAILURE;
            okId = EVENT_GUI_DIAGNOSTICS_RETORT_HEATING_EMPTY_TEST_SUCCESS;
            break;
