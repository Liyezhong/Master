...
//        }
    ...
    else if(PSSM_PROCESSING == stepState)
    {
        ...
        if((now - m_TimeStamps.CurStepSoakStartTime ) > period)//Will finish Soaking
        {
            ...
            {
                m_SchedulerCommandProcessor->pushCmd(new CmdALReleasePressure(500,  mp_SchedulerThreadController));
...
void CSchedulerStateHandler::DoCleaningDryStep(ControlCommandType_t ctrlCmd, SchedulerCommandShPtr_t cmd)
{
    ...
    case CDS_MOVE_TO_SEALING_13:
        CmdMvRV = new CmdRVReqMoveToRVPosition(500, mp_SchedulerThreadController);
    ...
    case CDS_WAIT_HIT_POSITION:
        if(cmd != NULL && ("Scheduler::RVReqMoveToRVPosition" == cmd->GetName()))
        {
            ...
            {
                m_SchedulerCommandProcessor->pushCmd(new CmdRVReqMoveToInitialPosition(500, mp_SchedulerThreadController));
...
void CSchedulerStateHandler::AllStop()
{
    ...
    m_SchedulerCommandProcessor->pushCmd(new CmdALAllStop(500, mp_SchedulerThreadController));
}
...
void CSchedulerStateHandler::HandleRmtLocAlarm(quint32 ctrlcmd)
{
    ...
    CmdRmtLocAlarm *cmd = new CmdRmtLocAlarm(500, mp_SchedulerThreadController);
...
void CSchedulerStateHandler::Pressure()
{
    ...
    m_SchedulerCommandProcessor->pushCmd(new CmdALPressure(500, mp_SchedulerThreadController));
    //m_TickTimer.start();
}
...
void CSchedulerStateHandler::Vaccum()
{
    ...
    m_SchedulerCommandProcessor->pushCmd(new CmdALVaccum(500, mp_SchedulerThreadController));
    //m_TickTimer.start();
}
...
void CSchedulerStateHandler::Fill()
{
    ...
    CmdALFilling* cmd  = new CmdALFilling(500, mp_SchedulerThreadController);
...
void CSchedulerStateHandler::Drain()
{
    ...
    CmdALDraining* cmd  = new CmdALDraining(500, mp_SchedulerThreadController);
