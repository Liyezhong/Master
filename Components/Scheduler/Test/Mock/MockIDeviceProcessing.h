...
public:
   //! Start device control layer configuration
    ...
    MOCK_METHOD2(IDSealingCheck, ReturnCode_t(qreal ThresholdPressure,DeviceControl::RVPosition_t));
    ...
    MOCK_METHOD1(RVReqMoveToCurrentTubePosition, ReturnCode_t(RVPosition_t RVPosition));
