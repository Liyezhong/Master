 ...
 */
/****************************************************************************/
CmdUpdateStationReagentStatus::CmdUpdateStationReagentStatus(int TimeOut, const QString& StationID, int CassetteCount, bool bUpdateCycle)
    : Command(TimeOut)
    , m_StationID(StationID)
    , m_IsUpdateCycle(bUpdateCycle)
