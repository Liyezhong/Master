...
#include <TestStubDataManager/Helper/Include/XmlConfigFileStrings.h>
#include <TestStubDataManager/Helper/Include/XmlConfigFileTimeOffset.h>
...
void MasterThreadController::CreateAndInitializeObjects() {
    ...
    mp_alarmHandler->moveToThread(this->thread());
...
//                      pRemoteCareHandler, (const DataLogging::DayEventEntry &));
//}
...
void MasterThreadController::OnGoReceived()
{
    ...
    try {
        ...
        // now start threads
        AttachControllersAndStartThreads(false);
    } catch(const Global::Exception &E) {
