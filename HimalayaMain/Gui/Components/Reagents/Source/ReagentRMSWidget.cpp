...
void CReagentRMSWidget::RetranslateUI()
{
    ...
    m_strConfirmRMSOffMode =  QApplication::translate("Reagents::CModifyReagentRMSDlg",
        "Do you really want to change RMS mode? When the RMS of cleaning reagent is turned off, the cleaning program can be run as usual, however, the qulity of cleaning reagent shall be controlled by user.", 0, QApplication::UnicodeUTF8);
