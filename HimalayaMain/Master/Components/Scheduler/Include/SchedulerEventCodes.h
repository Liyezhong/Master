...
const quint32 EVENT_SCHEDULER_START_PROGRAM_WITH_EXPIRED_REAGENT = SCHEDULER_BASE_ID + 0x0339;
...
const quint32 EVENT_SCHEDULER_PROGRAM_FINISH_PROCESS_LAST_STEP = SCHEDULER_BASE_ID + 0x033A;
