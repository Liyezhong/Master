...
#define L2_ERR_RS_RV_MOVETOPOSITIONSEAL             (0x17)
#define L2_ERR_RS_ABORT                             (0x18)
#define L2_ERR_RC_FORCEDRAINING                     (0x19)
...
typedef enum
{
    ...
    SM_ERR_RC_FORCEDRAINING = ((L2_ERR_RC_FORCEDRAINING << 8) | L1_ERROR),
...
typedef enum
{
    ...
    CTRL_CMD_TAKEOUT_SPECIMEN_FINISH,
    CTRL_CMD_QUITAPP,
    CTRL_CMD_SHUTDOWN,
    ...
    CTRL_CMD_USER_PRESS_OK_BUTTON_LOCK_RTLID_IDLE,
    CTRL_CMD_RC_CHECK_RTLOCK,
    CTRL_CMD_RC_REHEATING,
    CTRL_CMD_RC_REHEATING_5MINTIMEOUT,
    CTRL_CMD_RC_REHEATING_NONRESUME,
    CTRL_CMD_RS_REAGENTCHECK,
    CTRL_CMD_RS_RV_MOVETOSEALPOSITION,
    CTRL_CMD_RS_CHECKREMOTEALARMSTATUS,
    CTRL_CMD_RS_CHECKLOCALALARMSTATUS,
    ...
    CTRL_CMD_ALARM_DEVICE_ON,
    CTRL_CMD_ALARM_DEVICE_OFF,
