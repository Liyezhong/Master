...
#define L3_ERR_RS_RT_BOTTOM_STOP_TEMP_CTRL    (0x1)
#define L3_ERR_RS_RT_TOP_STOP_TEMP_CTRL       (0x2)
...
typedef enum
{
    ...
    SM_ERR_RS_RELEASE_PRESSURE_AT_RS_STADNDBY_WITHTISSUE = ((L3_ERR_RS_RELEASE_PRESSURE << 16) | (L2_ERR_RS_STANDBY_WITHTISSUE << 8) | L1_ERROR),
    SM_ERR_RS_SHUTDOWN_FAILED_HEATER_AT_RS_STADNDBY_WITHTISSUE = ((L3_ERR_RS_SHUTDOWN_FAILED_HEATER << 16) | (L2_ERR_RS_STANDBY_WITHTISSUE << 8) | L1_ERROR),
    SM_ERR_RS_RT_BOTTOM_STOP_TEMP_CTRL_AT_RS_STADNDBY_WITHTISSUE =((L3_ERR_RS_RT_BOTTOM_STOP_TEMP_CTRL << 16) | (L2_ERR_RS_STANDBY_WITHTISSUE << 8) | L1_ERROR),
    SM_ERR_RS_RT_TOP_STOP_TEMP_CTRL_AT_RS_STADNDBY_WITHTISSUE =((L3_ERR_RS_RT_BOTTOM_STOP_TEMP_CTRL << 16) | (L2_ERR_RS_STANDBY_WITHTISSUE << 8) | L1_ERROR)
