    ...
    ,m_StateACVoltageStepCount(0)
{
    ...
    mp_StateACHeating->addTransition(this, SIGNAL(SigSelfTestDone()), mp_Initial.data());

    CONNECTSIGNALSLOT(this, SigSelfTestDone(), mp_SchedulerThreadController, OnSelfTestDone());
