...
const quint32 EVENT_SERVICE_ACTIVECARBONTIME_OVERDUE	= 50331717;	///< The Active carbon filter is overdue, please replace a new Active carbon filter!
...
const quint32 EVENT_SWU_COPY_FILE_FAILED	= 50331720;	///< SW Update Failed: File/Folder copy failed from %1 to %2
const quint32 EVENT_SWU_FILE_DOES_NOT_EXIST	= 50331721;	///< SW Update Failed: File/Folder %1 does not exists
const quint32 EVENT_SWU_INVALID_COMMAND_LINE_ARGUMENTS	= 50331722;	///< SW Update Failed: Invalid Command line arguments:%1
const quint32 EVENT_SWU_MD5SUM_CHECK_FAILED	= 50331723;	///< SW Update Failed: Md5sum check failed:%1
const quint32 EVENT_SWU_CRC_CHECK_FAILED	= 50331724;	///< SW Update Failed: CRC check failed
const quint32 EVENT_SWU_SLAVE_VERSION_MISMACH	= 50331725;	///< SW Update Failed: Slave %1 has HW version %2 which is not equal or higher compared to %3
const quint32 EVENT_SWU_NO_USB_DEVICE	= 50331726;	///< SW Update Failed: No USB Device found
const quint32 EVENT_SWU_NO_UPDATE_PACKAGE_FOUND	= 50331727;	///< SW Update Failed: No Update Package found at %1
const quint32 EVENT_SWU_CREATE_FILE_FAIL	= 50331728;	///< SW Update Failed: File/Folder creation failed for %1
const quint32 EVENT_SWU_SLAVE_UPDATE_FAIL	= 50331729;	///< SW Update Failed: Slave SW update failed
const quint32 EVENT_SWU_FILE_DELETION_FAIL	= 50331730;	///< SW Update Failed: File/Folder deletion failed for %1
const quint32 EVENT_SWU_MISS_SLAVE	= 50331731;	///< SW Update Failed: Missing slave name %1 in %2
const quint32 EVENT_SWU_COPYING_FILE	= 50331732;	///< SW Update: Copying the File/Folder from %1 to %2
const quint32 EVENT_SWU_XML_ATTRIBUTE_MISMACH	= 50331733;	///< SW Update: XML attribute %1 found in %2 but not in %3
const quint32 EVENT_SWU_MOUNTING_USB_DEVICE	= 50331734;	///< SW Update: Mounting USB Device %1 to %2 passed
const quint32 EVENT_SWU_UNZIPPING_UPDATE_PACKAGE	= 50331735;	///< SW Update: Unzipping the update package %1 to %2
const quint32 EVENT_SWU_CRC_CHECK_PASSED	= 50331736;	///< SW Update: CRC check passed
const quint32 EVENT_SWU_MD5SUM_CHECK_PASSED	= 50331737;	///< SW Update: Md5sum check passed
const quint32 EVENT_SWU_SLAVE_VERSION_INFO	= 50331738;	///< SW Update: Slave %1 has HW version %2 is equal or higher compared to %3
const quint32 EVENT_SWU_CREATING_FILE	= 50331739;	///< SW Update: Creating File/Folder %1
const quint32 EVENT_SWU_EXTRACTING_PACKAGE	= 50331740;	///< SW Update: Extracting package from %1
const quint32 EVENT_SWU_EXECUTE_SCRIPT	= 50331741;	///< SW Update: Executing the script %1
const quint32 EVENT_SWU_ROLLINGBACK_FILES	= 50331742;	///< SW Update: Rolling back the files in %1 from %2
const quint32 EVENT_SWU_PARSING_XML	= 50331743;	///< SW Update: Parsing the XML file %1
const quint32 EVENT_SW_UPDATE_SUCCESS	= 50331744;	///< SW Update Success
const quint32 EVENT_SWU_MOUNTING_USB_DEVICE_FAIL	= 50331745;	///< SW Update: Mounting USB Device %1 to %2 failed
const quint32 EVENT_SWU_UPDATING_ALL_SW_FIRMWARE_FILES	= 50331746;	///< SW Update: %1 file not found. Updating all SW binaries and firmwares
const quint32 EVENT_SWU_CORRUPTED_UPDATING_ALL_SW_FIRMWARE_FILES	= 50331747;	///< SW Update: %1 file corrupted. Updating all SW binaries and firmwares
const quint32 EVENT_SWU_FILE_CORRUPTED	= 50331748;	///< SW Update: Failed %1 file corrupted.
const quint32 EVENT_SWU_EXECUTE_STARTER_SUCCESS	= 50331749;	///< SW Update: Execution of the starter succeeded
const quint32 EVENT_SWU_PTS_EXECUTION_SUCCESS	= 50331750;	///< SW Update: PTS execution is success
const quint32 EVENT_SWU_PTS_EXECUTION_FAILED	= 50331751;	///< SW Update: PTS execution is failed
const quint32 EVENT_SWU_UNMOUNT_USB	= 50331752;	///< SW Update: Unmounted USB to %1
...
const quint32 EVENT_SW_UPDATE_FAILED	= 50331756;	///< SW Update failed
const quint32 EVENT_IMPORT_TAMPERED_ARCHIVE_FILE	= 50331757;	///< Import failed. Archive file is tampered
const quint32 EVENT_IMPORT_DEVICE_NAME_NOT_MATCHING	= 50331758;	///< Import failed. SW versions are not matching to Import the files
const quint32 EVENT_IMPORT_TYPEOFIMPORTNOTVALID	= 50331759;	///< Type of import is not valid
const quint32 EVENT_IMPORTEXPORT_IMPORT_NO_USB	= 50331760;	///< No USB devices found in the system to import files
const quint32 EVENT_IMPORTEXPORT_EXPORT_NO_USB	= 50331761;	///< No USB devices found in the system to export files
